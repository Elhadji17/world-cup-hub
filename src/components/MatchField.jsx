...
function getPlayerArrows(pid, basePos, phase, formation) {
  ...
  const arrows = {
    ...
    "mane_10": {
      ...
      attaque_placee: [{ type:"chemin", path:`M ${bx} ${by} Q ${bx+40} ${by-30} ${bx+80} ${by-55}`, color:"#ef4444", label:"→ axe" }],
...
export default function MatchField({
  ...
  return (
    <div style={{ width:"100%", maxWidth:"360px", margin:"0 auto" }}>
      ...
      {timelineEvents.length > 0 && (phase === "idle" || !["playing","playing2"].includes(phase)) && (
        <div style={{
          marginTop:"10px",
