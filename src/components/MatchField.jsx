...
export default function MatchField({
  ...
  return (
    <div style={{ width:"100%", maxWidth:"360px", margin:"0 auto" }}>
      ...
      {/* ── Panneau Régie TV ── visible UNIQUEMENT hors simulation active */}
      {timelineEvents.length > 0 && !["playing","playing2"].includes(phase) && (
        <div style={{
          marginTop:"10px",
          ...
          <div style={{ marginBottom:"8px" }}>
            <div
              ...
              <div style={{
                width:`${(regieMin/93)*100}%`, height:"100%",
                background:"#16a34a",
          ...
          {lastEvent?.desc && (
            <div style={{
              ...
              borderLeftColor: lastEvent.type==="goal"
                ? (lastEvent.team==="me"||lastEvent.team==="sen" ? "#4ade80" : "#f87171")
                : "#f59e0b",
              fontSize:"10px", color:"#cbd5e1", lineHeight:"1.5",
            }}>
              <span style={{ color:"#94a3b8", fontFamily:"monospace", marginRight:"6px" }}>
                {lastEvent.minute}'
              </span>
      ...
      {/* Narration pendant la simulation — affichée seulement pendant le jeu */}
      {["playing","playing2"].includes(phase) && lastEvent?.desc && (
        <div style={{
