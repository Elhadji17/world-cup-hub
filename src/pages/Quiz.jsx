// src/pages/Quiz.jsx
// Quiz par catégorie — reçoit categoryId depuis l'URL
...
import questionsUCL                from "../data/questions-champions-league.json";
...
const QUESTIONS_MAP = {
  ...
  "daily":             questionsDefault, // À remplacer par questions du jour
};
...
export default function Quiz() {
  ...
  function replay() {
    navigate(0); // reload la page pour remélanger
  }
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-green-900 text-white pb-16">
        <div className="max-w-xl mx-auto px-4 pt-10">
          ...
          >
            ...
            <div className="text-gray-400 text-sm">Score final · {category.title}</div>
